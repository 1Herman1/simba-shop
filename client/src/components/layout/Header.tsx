      ...
      <div className="hidden md:block">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <Link to="/" className="flex items-center flex-shrink-0">
            <img src="/logo.png" alt="Симба" className="h-10 w-auto" />
          </Link>
          ...
          <div className="relative flex-1 max-w-xl mx-4">
            <input
              ...
              className="w-full pl-4 pr-12 py-2.5 rounded-full border border-blue-100 bg-white focus:outline-none focus:border-blue-200 focus:ring-2 focus:ring-blue-100 transition-[border-color,box-shadow] text-navy-900 placeholder-navy-300"
            />
            <button className="absolute right-3 top-1/2 -translate-y-1/2 text-navy-500 hover:text-primary-hover transition-colors duration-100 ease">
          ...
          <div className="flex items-center gap-5 flex-shrink-0">
            {/* Телефон */}
            <a href={CONTACTS.phoneHref} className="flex items-center gap-1.5 text-navy-700 hover:text-primary-hover transition-colors duration-100 ease group">
            ...
            {/* Избранное */}
            <Link to="/favorites" aria-label="Избранное" className="text-navy-500 hover:text-amber-400 transition-colors duration-100 ease">
            ...
            {/* Корзина */}
            <Link to="/cart" aria-label="Корзина" className="relative text-navy-500 hover:text-primary-hover transition-colors duration-100 ease">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Профиль */}
            <Link to="/profile" aria-label="Профиль" className="text-navy-500 hover:text-primary-hover transition-colors duration-100 ease">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
